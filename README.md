...
Hi 👋 I'm **Sujal Verma**, a passionate 🚀 **Full Stack Web Developer** and 🎓 **Information Technology** undergraduate at Shree L.R. Tiwari College of Engineering, Mumbai.
...
### 👥 I've gained hands-on industry experience through multiple internships where I: <br />
✨ Developed real-time chat apps and collaborative editors using Socket.io <br />
✨ Built responsive web interfaces and tracking tools <br />
✨ Integrated robust backend systems with MongoDB and PostgreSQL <br />
✨ Programmed real-time malware scanners and security configurations
<br />


🤖 Alongside web development, I actively explore **Generative AI integration**, building independent AI auditing layers for hallucination detection and smart AI productivity platforms.

📚 I believe in **clean code, continuous learning, and problem-solving**, and I'm constantly improving my skills in **Data Structures & Algorithms (Java), DBMS, and Core Computer Science**.
...
🧠 Strong in DSA (Java), DBMS & Core CS <br />
🛠️ Tech Stack: React | Node | Express | MongoDB | SQL | Git <br />
🌟 Generative AI Enthusiast <br />
📍 Mumbai, Maharashtra, India <br />

🔭 Working on real-world Full Stack & GenAI projects <br />
🌱 Learning Advanced React, System Design & AI Tools <br />
💬 Ask me about Web Development, WebSockets & APIs <br />
⚡ Fun Fact: I love turning ideas into production-ready products. 😄 <br />
